...
const TOKEN_DIR = './credentials/'; //the directory where we're going to save the token
const TOKEN_PATH = TOKEN_DIR + 'recieved.json'; //the file which will contain the token
...
class Authentication {
    ...
    getClientSecret(){
        return require('./clientSecret.json');
    }
